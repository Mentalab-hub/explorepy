...
class StreamProcessor:
    ...
    def set_ext_marker(self, marker_string, time_lsl=None, label='sw_'):
        ...
        ext_marker = ExternalMarker.create(marker_string=marker_string, lsl_time=time_lsl, label=label)
