...
# old3.xdf file has not synchronized data, and the other one has synchronized data
raw_data = mne_load_mentalab("sub-P001_ses-S001_task-Default_run-001_eeg_old3.xdf")
montage = mne.channels.make_standard_montage("standard_1020")
raw_data.set_montage(montage, match_case=False, on_missing="warn")
raw_data.save('salman_raw.fif')
